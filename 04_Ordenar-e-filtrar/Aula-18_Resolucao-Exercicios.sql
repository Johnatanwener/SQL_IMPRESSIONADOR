...
-- Quantas lojas a empresa tem no total?
SELECT * FROM DimStore 
-- A Contoso tem atualmente 306 lojas registradas.

-- Quantas lojas estão ativas e quais são elas?
SELECT 
...
-- A Contoso possui atualmente 294 lojas ativas e dessas 287 são do tipo 'Store'
...
-- Quando a coluna for do tipo date time o jeito de resolver o erro que ocorrerá é retirar o hífen entre as informações. Exemplo: 2009-03-15 para 20090315
...
SELECT * FROM DimStore WHERE CloseReason IS NOT NULL
...
/* Exercício 10: 
A empresa possui 16 produtos da marca Contoso, da cor Silver e com um Weight entre 10 e 30. Descubra quais são esses produtos e ordene o resultado em ordem decrescente de acordo com o preço (UnitPrice). */
